...
import com.cookietech.namibia.adme.chatmodule.utils.convertFromString
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ChatActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.chat_activity_main)
