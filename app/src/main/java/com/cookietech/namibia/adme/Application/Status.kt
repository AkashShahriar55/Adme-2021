...
object Status {
    ...
    const val status_client_request_cancel = "client_request_cancelled"
    ...
    const val status_provider_work_completed = "provider_work_completed"
    const val status_provider_request_cancel = "provider_request_cancelled"
    const val status_client_completion_approve = "client_completion_approve"
    const val status_client_completion_declined = "client_completion_declined"
