...
//        edt_needed_money.setText(appointment?.client_price)
    ...
    private fun stateUiConfirmedActive() {
        iv_state_pending.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.ic_state_completed, null))
        pending_confirme_line.setBackgroundColor(ContextCompat.getColor(this, R.color.sv_primary))
        iv_state_confirmed.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.ic_state_active, null))
        confirm_complete_line.setBackgroundColor(ContextCompat.getColor(this, R.color.border_ash))
        iv_state_completed.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.ic_state_inactive, null))
        complete_payment_line.setBackgroundColor(ContextCompat.getColor(this, R.color.border_ash))
        iv_state_payment.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.ic_state_inactive, null))
    }

    private fun stateUiCompletedActive() {
        iv_state_pending.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.ic_state_completed, null))
        pending_confirme_line.setBackgroundColor(ContextCompat.getColor(this, R.color.sv_primary))
        iv_state_confirmed.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.ic_state_completed, null))
        confirm_complete_line.setBackgroundColor(ContextCompat.getColor(this, R.color.sv_primary))
        iv_state_completed.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.ic_state_active, null))
        complete_payment_line.setBackgroundColor(ContextCompat.getColor(this, R.color.border_ash))
        iv_state_payment.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.ic_state_inactive, null))
    }
    ...
    private fun stateUiPaymentActive() {
        ...
        iv_state_confirmed.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.ic_state_completed, null))
        confirm_complete_line.setBackgroundColor(ContextCompat.getColor(this, R.color.sv_primary))
        iv_state_completed.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.ic_state_completed, null))
        complete_payment_line.setBackgroundColor(ContextCompat.getColor(this, R.color.sv_primary))
        iv_state_payment.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.ic_state_active, null))
    }
    ...
    private fun stateUiPaymentCompleted() {
        ...
        iv_state_completed.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.ic_state_completed, null))
        complete_payment_line.setBackgroundColor(ContextCompat.getColor(this, R.color.sv_primary))
        iv_state_payment.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.ic_state_completed, null))
    }
    ...
    private fun sendProviderResponse() {
        ...
        appointment?.apply {
            ...
            viewmodel.sendServiceProviderResponse(this).addOnSuccessListener {
                Toast.makeText(this@AppointmentDetailsActivity,"Response sent",Toast.LENGTH_SHORT).show()
                setUpUiForProviderResponseSendProvider()
            }.addOnFailureListener {
